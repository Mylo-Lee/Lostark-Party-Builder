...
import {
  addPlayer, removePlayer, togglePlayer,
...
function openSearchModal(searchName) {
  // 소유주 이름 기본값 = 검색어
  document.getElementById('modalOwnerName').value = searchName;
...
async function forceRefresh() {
  const name = document.getElementById('modalOwnerName').value.trim();
